...
- [MANUAL_INSTALACION_CLIENTE.md](file:///d:/programacio/repredi/ReprediSL_V4/Documentacion/MANUAL_INSTALACION_CLIENTE.md): Manual de instalación oficial en puesto cliente para la estructura `C:\pensi\psforce\` (Daemon, Sync, Caddy, Logs, Backup).
